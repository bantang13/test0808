<?php
	class Bantang_Test_MessageController extends Mage_Core_Controller_Front_Action{
		...
		public function postAction(){
			...
			//設定留言板網址
			$url = Mage::Helper('bantangtest')->getMessageUrl();//
			...
			//整理資料
			$Data = array('content' => $postData['message'],'name' => $name);
			// 呼叫 Model
